...
public class TableViewModel {
    ...
    public static final int GENDER_COLUMN_INDEX = 444;
    ...
    private static final int COLUMN_SIZE = ShopEquipment.getColumnNames().size();
    ...
    public TableViewModel(Context context,List<ShopEquipment> shopEquipmentsList) {
        mContext = context;
        this.shopEquipmentsList = shopEquipmentsList;
        ROW_SIZE = shopEquipmentsList.size();
    ...
    private List<RowHeader> getSimpleRowHeaderList() {
        ...
        for (int i = 0; i < ROW_SIZE; i++) {
            RowHeader header = new RowHeader(String.valueOf(i), "edit");
            list.add(header);
        }
    ...
    private List<ColumnHeader> getRandomColumnHeaderList() {
        List<ColumnHeader> list = new ArrayList<>();
        int j = 0;
        for (String str:ShopEquipment.getColumnNames()){
            ColumnHeader header = new ColumnHeader(String.valueOf(j), str);
            list.add(header);
            j++;
        }
        return list;
    ...
    public List<List<Cell>> getCellList() {
        return ShopEquipment.getCellList(shopEquipmentsList);
    }
