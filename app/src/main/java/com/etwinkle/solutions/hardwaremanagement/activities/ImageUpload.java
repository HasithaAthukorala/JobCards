...
import com.etwinkle.solutions.hardwaremanagement.models.Fault;
import com.etwinkle.solutions.hardwaremanagement.models.FaultJson;
...
public class ImageUpload extends Activity {
    ...
    Uri imageUri;
    private List<Fault> shopEquipmentsList;
...
//    }
    ...
    public void getDataFromRemoteServer() {
        ...
        GsonRequest<FaultJson> serverRequest = new GsonRequest<FaultJson>(
                Request.Method.GET,
        ...
        VolleySingleton.getInstance(ImageUpload.this).addToRequestQueue(serverRequest);
    }

    public Response.Listener<FaultJson> createRequestSuccessListener() {
        return new Response.Listener<FaultJson>() {
            @Override
            public void onResponse(FaultJson response) {
//                hideProgressDialog();
                try {
                    ...
                    if (response != null) {
                        ...
                        for(int i = 0; i < jsonElements.size(); i++) {
                            ...
                            Fault fault = new Fault(removeCommas(jsonObject.get("_id").toString()),removeCommas(jsonObject.get("faultName").toString()));
...
//                showProgress(false);
                Helper.displayErrorMessage(ImageUpload.this, "Something went wrong!", "error");
//                hideProgressDialog();
