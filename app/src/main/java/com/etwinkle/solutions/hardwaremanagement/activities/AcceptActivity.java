    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                sendDataFromRemoteServer(jobId,tId);
...
//    }
    ...
    public void getDataFromRemoteServer() {
        ...
        VolleySingleton.getInstance(AcceptActivity.this).addToRequestQueue(serverRequest);
    }
...
//                showProgress(false);
                Helper.displayErrorMessage(AcceptActivity.this, "Something went wrong!", "error");
//                hideProgressDialog();
    ...
    public void sendDataFromRemoteServer(String jobId,String eId) {
        ...
        GsonRequest<Success> serverRequest = new GsonRequest<Success>(
                Request.Method.POST,
                Helper.PATH_TO_SERVER_GET_TECH_ACCEPT,
                Success.class,
                params,
