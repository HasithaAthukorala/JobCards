...
import com.etwinkle.solutions.hardwaremanagement.fragments.CompleteFragment;
...
//        SSLEngine engine = sslContext.createSSLEngine();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent loginPageIntent = new Intent(EngineerActivity.this, LoginActivity.class);
