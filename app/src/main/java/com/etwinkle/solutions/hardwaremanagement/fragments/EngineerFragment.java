...
import com.etwinkle.solutions.hardwaremanagement.activities.ImageUpload;
...
import com.etwinkle.solutions.hardwaremanagement.models.PendingJobsJson;
...
public class EngineerFragment extends Fragment {
    ...
    public void getDataFromRemoteServer() {
        ...
        GsonRequest<PendingJobsJson> serverRequest = new GsonRequest<PendingJobsJson>(
                Request.Method.GET,
                Helper.PATH_TO_SERVER_GET_PENDING_JOBS,
                PendingJobsJson.class,
    ...
    public Response.Listener<PendingJobsJson> createRequestSuccessListener() {
        return new Response.Listener<PendingJobsJson>() {
            @Override
            public void onResponse(PendingJobsJson response) {
//                hideProgressDialog();
                try {
                    if (response != null) {
...
//                            Fault fault = new Fault(jsonObject.get("_id").toString(),jsonObject.get("faultName").toString());
                        ...
                        JobsAdapterAssign jobsAdapter = new JobsAdapterAssign(getContext(),pendingJobsList);
