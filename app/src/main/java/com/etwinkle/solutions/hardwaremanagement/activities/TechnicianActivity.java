...
import com.etwinkle.solutions.hardwaremanagement.fragments.TechnicianFragment;
...
//        SSLEngine engine = sslContext.createSSLEngine();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent loginPageIntent = new Intent(TechnicianActivity.this, LoginActivity.class);
